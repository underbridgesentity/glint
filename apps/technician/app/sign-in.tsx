...
import { Button, C, text } from '@glint/mobile-ui';

export default function SignIn() {
  const [email, setEmail] = useState('sipho.m@glint.co.za');
  ...
  const input = { backgroundColor: C.carbonRaise, color: C.white, borderWidth: 1, borderColor: C.carbonBorder, borderRadius: 8, paddingHorizontal: 16, paddingVertical: 14, fontSize: 15, fontFamily: 'Inter_400Regular' };
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: C.carbon }}>
      <View style={{ flex: 1, justifyContent: 'center', paddingHorizontal: 28, gap: 14 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 9, marginBottom: 10 }}>
          ...
          <Text style={{ fontFamily: 'Inter_700Bold', fontSize: 22, letterSpacing: -0.6, color: C.white }}>Glint Tech</Text>
        </View>
        <Text style={[text.h1, { fontSize: 30 }]}>On shift.</Text>
        <Text style={[text.body, { marginBottom: 8 }]}>Sign in to see your queue and log washes.</Text>
        ...
        <Text style={[text.meta, { textAlign: 'center', marginTop: 4 }]}>Demo: sipho.m@glint.co.za · glint1234</Text>
      </View>
    </SafeAreaView>
  );
}
